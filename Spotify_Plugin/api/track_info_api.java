...
public final class track_info_api {
	...
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Spotify_Plugin.api.track_info_api";
		...
		passThroughData.put("flowRef", "packages/Spotify_Plugin/api/track_info_api.api");
		...
		try{
		  ...
		  mainflowJsonObject = (JsonObject) passThroughData.get("mainflowJsonObject");
			...
			throw new SnippetException(dataPipeline,"Failed to execute track_info_api", new Exception(e));
		}finally{
			try{
